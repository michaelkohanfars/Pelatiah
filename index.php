...
<head>
	...
	<meta name="Description" content="Pelatiah Clothing, Pelatiah Fashion, plus size tops, plus size dresses, plus size clothes, plus size contractor, plus size alterations, pelatiah plus sizes">
    
    <title>Pelatiah Clothing</title>
	...
	<!-- Scripts for trunk js --> 
	<script type="text/javascript">
		if (typeof jQuery == 'undefined')
			document.write(unescape("%3Cscript src='http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js'%3E%3C/script%3E"))
	</script>
   ...
   <div class='popbox'>
     ...
     <div class='collapse'>
       <div class='box'>
         ...
         <img src="contact_info.jpg" alt="" style="width:250px;position:relative;" />
